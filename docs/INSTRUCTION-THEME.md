...
One of the most unique aspects of the project is definitely the "Route" structure. You can set Aside, Header, Footer and of course Content for any path you want, you can even not put them if you wish.

You can use all props of the React Router Dom when defining a route
...
If you don't want it to be Aside in a path, simply give theelement prop the value null.

# ExamplePageAside.tsx
...
If you don't want it to be Header in a path, simply give theelement prop the value null.
